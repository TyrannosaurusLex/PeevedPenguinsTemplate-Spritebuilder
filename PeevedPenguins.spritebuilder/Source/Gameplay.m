...
//  PeevedPenguins
//
//  Created by Lex Lehr on 7/18/14.
...
-(void) touchBegan:(UITouch *)touch withEvent:(UIEvent *)event
{
    ...
    if (CGRectContainsPoint([_catapultArm boundingBox], touchLocation))
    {
        ...
        //initially position it in the scoop, 34,138 is the position in the node space of the _catapultArm
...
-(void)ccPhysicsCollisionPostSolve:(CCPhysicsCollisionPair *)pair seal:(CCNode *)nodeA wildcard:(CCNode *)nodeB
{
    ...
    //if eneregy is large enough, remove the seal
    if (energy > 5000.f){
...
-(void) launchPenguin{
    ...
    //ensured followed object is in visible area when starting
